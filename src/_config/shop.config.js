...
// Order status
export const STATUS_PENDING_VENDOR_APPROVE = "PENDING_VENDOR_APPROVE";
export const STATUS_DENIED_BY_VENDOR = "DENIED_BY_VENDOR";
export const STATUS_USER_CANCEL = "STATUS_USER_CANCEL";

export const STATUS_IDLE = "IDLE";
export const STATUS_ASSIGNING = "ASSIGNING";
export const STATUS_ACCEPTED_BY_VENDOR = "ACCEPTED";
